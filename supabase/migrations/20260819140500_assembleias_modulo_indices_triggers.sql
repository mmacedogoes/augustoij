-- Índices, Triggers e Funções de Integridade
...
-- Função de Integridade de Votos
...
BEGIN
    -- Serialização via advisory lock
...
-- Trigger: Bloquear Edição de Voto
...
BEGIN
    ...
    -- Permite apenas alteração de campos de invalidação
...
-- Trigger: Normalização de Destinatário
