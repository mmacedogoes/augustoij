-- Cache de respostas do chat por condomínio (economia de créditos)
...
create index if not exists chat_cache_lookup_idx
  on public.chat_cache (condominio_id, pergunta_hash, expires_at desc);
...
create policy "chat_cache_members_select" on public.chat_cache
...
create policy "chat_cache_members_insert" on public.chat_cache
...
create policy "chat_cache_members_update" on public.chat_cache
