...
BEGIN
    -- Remove caracteres ambíguos e limita tamanho
...
-- (Simplificando aqui para exemplo, na prática seguiria toda a lista exaustiva)
...
-- Habilitar RLS e RLS Policies iniciais (exemplo p/ assembleias)
...
-- Buckets de Storage
INSERT INTO storage.buckets (id, name, public) VALUES ('assembleia-planilhas', 'assembleia-planilhas', false);
INSERT INTO storage.buckets (id, name, public) VALUES ('assembleia-gravacoes', 'assembleia-gravacoes', false);
INSERT INTO storage.buckets (id, name, public) VALUES ('assembleia-procuracoes', 'assembleia-procuracoes', false);

-- Políticas de Storage (Super Admin)
CREATE POLICY "Super admins can manage storage" ON storage.objects
    FOR ALL TO authenticated
