...
export const Route = createFileRoute("/termos")({
  head: () => ({
    meta: [
      { title: "Termos de uso — CondoIA" },
      { name: "description", content: "Termos de uso da plataforma CondoIA." },
    ],
  }),
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <section className="mt-8 space-y-4 text-sm text-foreground leading-relaxed">
          <p><strong>1. Aceitação.</strong> Ao criar uma conta no CondoIA você concorda com estes Termos. Caso não concorde, não utilize a plataforma.</p>
          <p><strong>2. O que o CondoIA é.</strong> Uma ferramenta de inteligência artificial que auxilia síndicos e administradoras a interpretar documentos e operar condomínios. As respostas têm <em>caráter de apoio</em> e não substituem consulta jurídica ou contábil formal.</p>
          ...
          <p><strong>4. Conteúdo e propriedade.</strong> Você mantém a titularidade dos documentos enviados. Concede licença limitada ao CondoIA apenas para processá-los e gerar respostas.</p>
