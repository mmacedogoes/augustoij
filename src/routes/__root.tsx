...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Augusto.IJ — a inteligência jurídica especializada em direito condominial. Responde, fundamenta e cita acórdãos. Dura lex, sed Augusto." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Augusto.IJ — Inteligência Jurídica para Condomínios" },
      { name: "twitter:description", content: "Augusto.IJ — a inteligência jurídica especializada em direito condominial. Responde, fundamenta e cita acórdãos. Dura lex, sed Augusto." },
