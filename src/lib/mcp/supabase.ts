/**
 * Fábrica de clientes Supabase para as ferramentas MCP.
 * Import-safe: nenhuma leitura de env no topo do módulo.
 */
...
/** Cliente com o token verificado do chamador — a RLS roda como o usuário. */
...
/** Resposta padrão de erro para as ferramentas. */
export function erro(text: string) {
  return { content: [{ type: "text" as const, text }], isError: true as const };
}

/** Resposta padrão de sucesso com JSON legível. */
